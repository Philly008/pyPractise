...
from ui_framework.Base.BaseOperate import OperateElement
import time
from ui_framework.Base.BaseElementEnum import Element as be
import os
from ui_framework.PageObject.SumResult import statistics_result
from ui_framework.Base.BaseError import get_error
...
class PagesObjects:
    ...
    def checkPoint(self, kwargs={}):
        ...
        statistics_result(result=result, testInfo=self.testInfo, caseName=self.caseName,
                          ...
                          testCase=self.testCase, testCheck=self.test_check)
