...
class OperateReport:
    ...
    def init(self, worksheet, data):
        ...
        worksheet.merge_range('A2:D2', '康源LIS项目', define_format_H2)
    ...
    def detail(self, worksheet, info):
        ...
        worksheet.merge_range('A1:J1', '测试详情', get_format(self.wd, {'bold': True, 'font_size': 18,
                                                                    'align': 'center', 'valign': 'vcenter',
                                                                    'bg_color': 'blue', 'font_color': '#ffffff'}))
